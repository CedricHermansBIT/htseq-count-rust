...
The fitted TallySeq runtime was \ScalingTallyIntercept{} + \ScalingTallySlope{} seconds per million alignments ($R^2=\ScalingTallyRSquared$). The HTSeq fit was \ScalingHTSeqIntercept{} + \ScalingHTSeqSlope{} seconds per million alignments ($R^2=\ScalingHTSeqRSquared$). The fitted per-million-record slope was therefore about 21.7 times larger for HTSeq. Peak resident memory remained nearly constant across the four record counts for both tools.
